          ...
          <div v-else class="user-details-content">
            ...
            <div class="user-stats-grid">
              ...
              <div class="stat-card">
                ...
                <div class="stat-info">
                  <span class="stat-value">{{ userStats.totalHours || 0 }}h</span>
                  <span class="stat-label">Total Parked Hours</span>
                </div>
              </div>
                ...
                <div v-if="userStats.recentReservations && userStats.recentReservations.length > 0">
                  <div v-for="reservation in userStats.recentReservations.slice(0, 3)" :key="reservation.id" class="activity-item">
                    ...
                    <div class="activity-content">
                      <span class="activity-title">{{ reservation.location_name }}</span>
                      <span class="activity-time">{{ formatDate(reservation.created_at) }}</span>
                    </div>
...
const viewUserDetails = async (user) => {
  ...
  try {
    ...
    if (reservationsResponse && reservationsResponse.reservations) {
      ...
      const totalHours = reservations.reduce((sum, res) => sum + (res.duration_hours || 0), 0)
